...
compare = []
if __name__ == '__main__':
    inputs = glob.glob('inputs/large2/*') #change large1     dzj: large2 lzw: large3
    inputs = iter(inputs)
...
=======
    write_output_file(D, 'outputs/large-193-try.out')
...
#             print(input_path)
#             cur_file = basename(normpath(input_path))[:-3]
#             output_path = 'outputs/large_genetic/' + cur_file + '.out'
#             G, s = read_input_file(input_path)
#             D = solve(G, s)
#             # D, k = solve(G, s)
#             # assert is_valid_solution(D, G, s, k)
...
>>>>>>> 10cc357d7810170cb2cbd380f3ae01b0153c9535
